...
```sh
#option 1: pass in the env var at runitime from the command line

ALPHAVANTAGE_API_KEY="________" python -m app.stocks

#option 2 after we set up our env var in the .env vile, run as is
```
